...
import type { Product as _Product, ProductCategory as _ProductCategory, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: ProductCategory, arg2: string, arg3: bigint, arg4: string, arg5: bigint, arg6: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, to_candid_ProductCategory_n8(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrder(arg0: string, arg1: string, arg2: ShippingAddress, arg3: Array<OrderItem>): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "jewellery" in value ? ProductCategory.jewellery : "nails" in value ? ProductCategory.nails : value;
}
